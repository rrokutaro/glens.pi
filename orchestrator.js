...
const CONFIG = {
    ...
    audit: {
        ...
        limit:       parseInt(process.env.ORCH_AUDIT_LIMIT || '80', 10),
    ...
    textExtraction: {
        ...
        sourceLimit:      parseInt(process.env.ORCH_TEXT_EXTRACT_SOURCE_LIMIT || '100', 10),
        batchSize:        parseInt(process.env.ORCH_TEXT_EXTRACT_BATCH_SIZE || '50', 10),
        llmBatchSize:     parseInt(process.env.ORCH_TEXT_LLM_BATCH_SIZE || '4', 10),
